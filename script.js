...
if(isRecord){
  ...
  const rs=document.createElement('style');rs.textContent=`
    ...
    .vinyl-disc{width:28px;height:28px}
...
function gridPos(n){let cw=isRecord?280:370,ch=isRecord?380:480,cols,rows;
  if(n===3){cols=3;rows=1;cw=isRecord?230:340}
  else if(n===2){cols=2;rows=1;cw=isRecord?260:360}
